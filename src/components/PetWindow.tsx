...
export function PetWindow() {
  ...
  useEffect(() => {
    ...
    async function boot() {
      ...
      const activePetId = resolveActivePetId(loadedSettings.activePetId, foundPackages);
  ...
  const activePet = useMemo(() => {
    const activePetId = resolveActivePetId(settings.activePetId, packages);
    return packages.find((candidate) => candidate.id === activePetId);
